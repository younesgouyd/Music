...
abstract class UnsetSpotifyTrack {
    ...
    open suspend fun execute(
        ...
        println("--> UnsetSpotifyTrackDao::execute")
        ...
        if (removeAlbum) {
            println("UnsetSpotifyTrackDao::execute | removing album: $spotifyAlbumId")
            ...
            println("UnsetSpotifyTrackDao::execute | mediaFilesToDelete.size: ${mediaFilesToDelete.size}, mediaFilesToDelete: $mediaFilesToDelete")
